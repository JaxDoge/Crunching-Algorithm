...
# We calculate the results of [0:num1] and [0:num2]
# The state only need the previous 2 digits then we know if there is a wave
# If there is a wave, the actual wave number contribute from it is not just one.
# Instead, it depends on how many numbers can be constructed from this prefix
